...
pdata;
  ...
  public lookbooklist() {
    ...
    this.http.get(this.appsetting.myGlobalVar + 'lookbooks/firstlistofaffiliates', options).map(res => res.json()).subscribe(data => {
      console.log(data)
      ...
      if(data.data){
          ...
          //   console.log('repeat');
          for(let pdata of data.data){
        this.items.push(pdata);
